import{m as t,n as e}from"./index-BoiRAJzP.js";const c=({children:r,className:i="",hoverEffect:n=!0,onClick:a,delay:d=0})=>{const s={initial:{opacity:0,y:15},animate:{opacity:1,y:0},transition:{duration:.4,delay:d*.05,ease:[.16,1,.3,1]}},o=`
