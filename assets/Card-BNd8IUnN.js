import{o as e,p as i}from"./index-BCx4eP2B.js";const l=({children:r,className:n="",hoverEffect:d=!0,onClick:a,delay:m=0,id:o})=>{const s={initial:{opacity:0,y:15},animate:{opacity:1,y:0},transition:{duration:.4,delay:m*.05,ease:[.16,1,.3,1]}},t=`
