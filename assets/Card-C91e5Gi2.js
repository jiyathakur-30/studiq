import{t as e,u as i}from"./index-B6jWliaG.js";const u=({children:r,className:n="",hoverEffect:d=!0,onClick:a,delay:m=0,id:s})=>{const o={initial:{opacity:0,y:15},animate:{opacity:1,y:0},transition:{duration:.4,delay:m*.05,ease:[.16,1,.3,1]}},t=`
